...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        democracy: {
             ...
             **/
            Vetoed: AugmentedEvent<ApiType, [who: AccountId32, proposalHash: H256, until: u64], {
                who: AccountId32;
                proposalHash: H256;
                until: u64;
            }>;
        ...
        indices: {
             ...
             **/
            IndexAssigned: AugmentedEvent<ApiType, [who: AccountId32, index: u64], {
                who: AccountId32;
                index: u64;
            }>;
            /**
             ...
             **/
            IndexFreed: AugmentedEvent<ApiType, [index: u64], {
                index: u64;
            }>;
            /**
             * A account index has been frozen to its current account ID.
             **/
            IndexFrozen: AugmentedEvent<ApiType, [index: u64, who: AccountId32], {
                index: u64;
                who: AccountId32;
            }>;
        };
        ...
        proxy: {
             ...
             **/
            AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: SpiritnetRuntimeProxyType, disambiguationIndex: u16], {
             ...
             * A proxy was added.
             **/
            ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: SpiritnetRuntimeProxyType, delay: u64], {
             ...
             * A proxy was removed.
             **/
            ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: SpiritnetRuntimeProxyType, delay: u64], {
                delegator: AccountId32;
                delegatee: AccountId32;
                proxyType: SpiritnetRuntimeProxyType;
                delay: u64;
        ...
        scheduler: {
             ...
             **/
            CallLookupFailed: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<Bytes>, error: FrameSupportScheduleLookupError], {
                task: ITuple<[u64, u32]>;
                id: Option<Bytes>;
             ...
             **/
            Dispatched: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<Bytes>, result: Result<Null, SpRuntimeDispatchError>], {
                task: ITuple<[u64, u32]>;
                id: Option<Bytes>;
                result: Result<Null, SpRuntimeDispatchError>;
            }>;
        ...
        web3Names: {
             ...
             **/
            Web3NameBanned: AugmentedEvent<ApiType, [name: Bytes], {
                name: Bytes;
            }>;
            /**
             * A new name has been claimed.
             **/
            Web3NameClaimed: AugmentedEvent<ApiType, [owner: AccountId32, name: Bytes], {
                owner: AccountId32;
                name: Bytes;
            }>;
            /**
             ...
             **/
            Web3NameReleased: AugmentedEvent<ApiType, [owner: AccountId32, name: Bytes], {
                owner: AccountId32;
                name: Bytes;
            }>;
            /**
             ...
             **/
            Web3NameUnbanned: AugmentedEvent<ApiType, [name: Bytes], {
                name: Bytes;
            }>;
        };
        xcmpQueue: {

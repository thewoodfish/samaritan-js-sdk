...
exports.getSubscribedNodes = void 0;
...
function getSubscribedNodes(contract, api, account, did) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, result, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.getSubscribers(account.address, {
...
exports.getSubscribedNodes = getSubscribedNodes;

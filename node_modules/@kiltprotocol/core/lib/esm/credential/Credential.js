 ...
 */
import { isDidSignature, verifyDidSignature, resolveKey, signatureToJson, signatureFromJson, } from '@kiltprotocol/did';
 ...
 * @returns The hash.
 */
export function calculateRootHash(credential) {
 ...
 */
export function removeClaimProperties(credential, properties) {
    const presentation = 
 ...
 */
export function makeSigningData(input, challenge) {
 ...
 */
export function verifyRootHash(input) {
 ...
 */
export function verifyDataIntegrity(input) {
    // check claim hash
 ...
 */
export function verifyAgainstCType(credential, ctype) {
 ...
 */
export async function verifySignature(input, { challenge, didResolveKey = resolveKey, } = {}) {
    const { claimerSignature } = input;
    if (challenge && challenge !== claimerSignature.challenge)
        throw new SDKErrors.SignatureUnverifiableError('Challenge differs from expected');
 ...
 */
export function fromClaim(claim, { legitimations = [], delegationId = null } = {}) {
 ...
 */
export async function verifyCredential(credential, { ctype } = {}) {
    verifyDataStructure(credential);
 ...
 */
export async function verifyPresentation(presentation, { ctype, challenge, didResolveKey = resolveKey } = {}) {
 ...
 */
export function isICredential(input) {
    try {
 ...
 */
export function isPresentation(input) {
    return (isICredential(input) &&
        isDidSignature(input.claimerSignature));
}
/**
 ...
 */
export function getHash(credential) {
 ...
 */
export async function createPresentation({ credential, signCallback, selectedAttributes, challenge, }) {

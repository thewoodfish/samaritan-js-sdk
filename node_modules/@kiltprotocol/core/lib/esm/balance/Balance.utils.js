 ...
 */
export function formatKiltBalance(amount, additionalOptions) {
    const options = {
        withSi: true,
        decimals: 15,
        withSiFull: true,
 ...
 */
export function convertToTxUnit(balance, power) {
 ...
 */
export function balanceNumberToString(input) {
 ...
 */
export function toFemtoKilt(input, unit = 'KILT') {
 ...
 */
export function fromFemtoKilt(input, decimals = 4, options) {

 ...
 */
import type { DidResourceUri, DidUri, DidVerificationKey, VerificationKeyRelationship } from './DidDocument.js';
/**
 ...
 */
export declare type SignCallback = (signData: SignRequestData) => Promise<SignResponseData>;
/**
 * A callback function to sign extrinsics.
 */
export declare type SignExtrinsicCallback = (signData: SignRequestData) => Promise<Omit<SignResponseData, 'keyUri'>>;
/**

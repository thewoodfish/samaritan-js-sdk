...
import { encryptionKeyTypesMap, verificationKeyTypesMap, } from '@kiltprotocol/types';
 ...
 */
export function exportToDidDocument(did, mimeType) {
    switch (mimeType) {
        ...
        default:
            throw new SDKErrors.DidExporterError(`The MIME type "${mimeType}" not supported by any of the available exporters`);
    }
}

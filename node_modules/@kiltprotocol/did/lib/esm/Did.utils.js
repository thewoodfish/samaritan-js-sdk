 ...
 */
export function isSameSubject(didA, didB) {
 ...
 */
export function validateUri(input, expectType) {
    ...
    if (fragment &&
        ...
        throw new SDKErrors.DidError('Expected a Kilt DidUri but got a DidResourceUri (containing a #fragment)');
    }
    if (!fragment && expectType === 'ResourceUri') {
        throw new SDKErrors.DidError('Expected a Kilt DidResourceUri (containing a #fragment) but got a DidUri');
    }
 ...
 */
export function getAddressByKey({ publicKey, type, }) {
 ...
 */
export function getFullDidUri(didOrAddress, version = FULL_DID_LATEST_VERSION) {

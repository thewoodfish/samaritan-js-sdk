...
exports.getExtrinsicError = exports.extrinsicSuccessful = exports.extrinsicFailed = void 0;
/**
...
exports.extrinsicFailed = extrinsicFailed;
/**
 ...
 */
function extrinsicSuccessful(extrinsicResult) {
    return extrinsicResult.events.some((eventRecord) => {
        const { section, method } = eventRecord.event;
        return section === 'system' && method === 'ExtrinsicSuccess';
    });
}
exports.extrinsicSuccessful = extrinsicSuccessful;
/**
 ...
 */
function getExtrinsicError(extrinsicResult) {

 ...
 */
export function IS_READY(result) {
 ...
 */
export function IS_IN_BLOCK(result) {
 ...
 */
export function EXTRINSIC_EXECUTED(result) {
 ...
 */
export function IS_FINALIZED(result) {
 ...
 * @returns Whether the extrinsic reached status "is ready".
 */
export function EXTRINSIC_FAILED(result) {
 ...
 */
export async function submitSignedTx(tx, opts = {}) {
    ...
    try {
        ...
        throw ErrorHandler.getExtrinsicError(e) || e;
    }
    finally {
        unsubscribe();
 ...
 */
export async function signAndSubmitTx(tx, signer, { tip, ...opts } = {}) {

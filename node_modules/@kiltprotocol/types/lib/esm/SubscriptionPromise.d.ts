...
export declare type ResultEvaluator = Evaluator<ISubmittableResult>;
export declare type ErrorEvaluator = Evaluator<Error>;
export declare type Options = TerminationOptions<ISubmittableResult>;

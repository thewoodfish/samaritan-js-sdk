 ...
 */
export function addDelegationToChainArgs(delegation, signature) {
    return [
        delegation.id,
        delegation.parentId || '',
 ...
 */
export async function fetch(delegationId) {
 ...
 */
export async function getChildren(delegationNode) {
 ...
 */
export async function getAttestationHashes(id) {
    const api = ConfigService.get('api');

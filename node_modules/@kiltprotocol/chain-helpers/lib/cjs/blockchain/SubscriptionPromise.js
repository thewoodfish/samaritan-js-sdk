...
exports.makeSubscriptionPromiseMulti = exports.makeSubscriptionPromise = void 0;
 ...
 */
function makeSubscriptionPromise(terminationOptions) {
    ...
    const subscription = typeof rejectOn === 'function'
        ? (value) => {
    ...
    if (timeout > 0)
        setTimeout(() => {
            reject(new utils_1.SDKErrors.TimeoutError());
        }, timeout);
    return { promise, subscription };
}
exports.makeSubscriptionPromise = makeSubscriptionPromise;
/**
 ...
 */
function makeSubscriptionPromiseMulti(args) {
    const promises = [];
    const subscriptions = [];
...
exports.makeSubscriptionPromiseMulti = makeSubscriptionPromiseMulti;

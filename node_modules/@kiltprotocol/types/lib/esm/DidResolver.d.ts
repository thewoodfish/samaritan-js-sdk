 ...
 */
import { ConformingDidKey, ConformingDidServiceEndpoint } from './DidDocumentExporter.js';
import type { DidDocument, DidKey, DidResourceUri, DidUri, KeyRelationship } from './DidDocument.js';
/**
 ...
 */
export declare type DidResolutionDocumentMetadata = {
    /**
...
export declare type ResolvedDidKey = Pick<ConformingDidKey, 'id' | 'controller'> & Pick<DidKey, 'publicKey' | 'type' | 'includedAt'>;
export declare type ResolvedDidServiceEndpoint = ConformingDidServiceEndpoint;
/**
 ...
 * cannot be resolved.
 */
export declare type DidResolve = (did: DidUri) => Promise<DidResolutionResult | null>;
/**
 ...
 */
export declare type DidResolveKey = (didUri: DidResourceUri, expectedVerificationMethod?: KeyRelationship) => Promise<ResolvedDidKey>;

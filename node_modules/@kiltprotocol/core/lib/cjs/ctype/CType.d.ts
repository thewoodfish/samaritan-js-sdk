 ...
 */
import type { ICType, IClaim, ICTypeMetadata, CTypeHash } from '@kiltprotocol/types';
/**
 ...
 */
export declare function serializeForHash(cType: ICType | Omit<ICType, '$id'>): string;
/**
 ...
 */
export declare function getHashForSchema(cType: ICType | Omit<ICType, '$id'>): CTypeHash;
/**
 ...
 */
export declare function hashToId(hash: CTypeHash): ICType['$id'];
/**
 ...
 */
export declare function idToHash(id: ICType['$id']): CTypeHash;
/**
 ...
 * @returns Schema id uri.
 */
export declare function getIdForSchema(schema: ICType | Omit<ICType, '$id'>): ICType['$id'];
/**
 ...
 */
export declare function verifyObjectAgainstSchema(object: Record<string, any>, schema: Record<string, any>, messages?: string[]): void;
/**
 ...
 */
export declare function verifyClaimAgainstSchema(claimContents: IClaim['contents'], schema: ICType, messages?: string[]): void;
/**
 * Checks on the KILT blockchain whether a CType is registered.
 *
 * @param ctype CType data.
 */
export declare function verifyStored(ctype: ICType): Promise<void>;
/**
 ...
 */
export declare function verifyDataStructure(input: ICType): void;
/**
 ...
 * @param messages - Optional empty array. If passed, this receives all verification errors.
 */
export declare function verifyClaimAgainstNestedSchemas(cType: ICType, nestedCTypes: ICType[], claimContents: Record<string, any>, messages?: string[]): void;
/**
 * Checks a CTypeMetadata object.
 *
 * @param metadata [[ICTypeMetadata]] that is to be instantiated.
 */
export declare function verifyCTypeMetadata(metadata: ICTypeMetadata): void;
/**
 ...
 */
export declare function fromProperties(title: ICType['title'], properties: ICType['properties']): ICType;
/**
 ...
 */
export declare function isICType(input: unknown): input is ICType;
